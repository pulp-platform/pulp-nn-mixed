    ...
    if(padding_x_left > 0)
    {
      do
      {
        ...
        do
        {
          ...
          uint32_t ptrB_2 = (uint32_t *) (pIm2Col + ((dim_out_y >> 1) * stride_y * dim_kernel_x));
          uint32_t ptrB2 = (uint32_t *) pIm2Col2;
          uint32_t ptrB2_2 = (uint32_t *) (pIm2Col2 + ((dim_out_y >> 1) * stride_y * dim_kernel_x));
          uint32_t ptrB3 = (uint32_t *) pIm2Col3;
          uint32_t ptrB3_2 = (uint32_t *) (pIm2Col3 + ((dim_out_y >> 1) * stride_y * dim_kernel_x));
          uint32_t ptrB4 = (uint32_t *) pIm2Col4; 
          uint32_t ptrB4_2 = (uint32_t *) (pIm2Col4 + ((dim_out_y >> 1) * stride_y * dim_kernel_x));
        ...
        if(dim_out_y&0x1){
          ...
          do{
            ...
            sum4 = MacLoad4(1, 0, 3, 1, ptrA4, sum4);
            ptrA4 = MacLoadUpdate(ptrA4);
            ptrA  = MacLoadInit(1, 0, 0, 0, ptrA);
            ptrA2 = MacLoadInit(1, 0, 1, 0, ptrA2);
            ptrB  = MacLoadInit(0, 1, 0, 0, ptrB);
