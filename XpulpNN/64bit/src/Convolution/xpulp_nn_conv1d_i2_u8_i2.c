...
void __attribute__((noinline)) xpulp_nn_conv1d_i2_u8_i2(
                        int8_t *pIn,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  int8_t * pIm2ColBase = pIm2ColBuffer + (2 * core_id * PACK_INT2_SIZE(ch_in) * dim_kernel_x);
  int i_out_x, i_ker_x;
  int Log2Core;
