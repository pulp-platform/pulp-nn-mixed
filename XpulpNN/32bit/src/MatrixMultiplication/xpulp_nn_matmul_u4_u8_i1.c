...
uint8_t * __attribute__((noinline)) xpulp_nn_matmul_u4_u8_i1(
                        uint8_t *pIn,
                        int8_t *pBias,
                        uint8_t *pOut,
                        uint8_t *pOut2,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 2); i++)
  {
    ...
    pA  = pulp_nn_i1_to_i4(pA , vecA);
    pA2 = pulp_nn_i1_to_i4(pA2, vecA2);
    pA3 = pulp_nn_i1_to_i4(pA3, vecA3);
    pA4 = pulp_nn_i1_to_i4(pA4, vecA4);
