...
%if config.kernel.in_data_t == config.kernel.wt_data_t:
      ...
      ptrB  = MacLoadInit(0, 1, 0, 0, ptrB);
%elif (int(config.kernel.wt_data_t/config.kernel.in_data_t) == 4):
      sum = ${macload_fn}(1, 0, 0, 0, ptrA, sum);
      ptrA = MacLoadUpdate(ptrA);
      ...
      ptrB  = MacLoadInit(0, 1, 0, 0, ptrB);
%elif (int(config.kernel.wt_data_t/config.kernel.in_data_t) == 2):
      sum = ${macload_fn}(1, 0, 0, 0, ptrA, sum);
      ptrA = MacLoadUpdate(ptrA);
      ...
      ptrB = MacLoadInit(0, 1, 0, 0, ptrB);
%elif (int(config.kernel.in_data_t/config.kernel.wt_data_t) == 4):
