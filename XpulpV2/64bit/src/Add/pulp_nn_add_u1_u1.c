...
void __attribute__ ((noinline)) pulp_nn_add_u1_u1(
    uint8_t * pIn1,
    uint8_t * pIn2,
    uint8_t * pOut,
    uint16_t out_mult1,
    ...
    uint16_t ch_im_in)
{
    ...
    {
        out1 = pulp_nn_add_quant_u1(*target1_ext, *target2_ext, out_mult1, out_mult2, out_shift);
        out2 = pulp_nn_add_quant_u1(*(target1_ext + 1), *(target2_ext + 1), out_mult1, out_mult2, out_shift);
        out3 = pulp_nn_add_quant_u1(*(target1_ext + 2), *(target2_ext + 2), out_mult1, out_mult2, out_shift);
        out4 = pulp_nn_add_quant_u1(*(target1_ext + 3), *(target2_ext + 3), out_mult1, out_mult2, out_shift);
