                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 3); i++)
  {
    ...
    for(int j=0; j<(num_col_im2col_w >> 2); j++)
    {
      ...
      pA1 = pulp_nn_i2_to_i8(pA1,vecA1);
      ...
      pA5 = pulp_nn_i2_to_i8(pA5,vecA5);
      ...
      pA6 = pulp_nn_i2_to_i8(pA6,vecA6);
      ...
      pA7 = pulp_nn_i2_to_i8(pA7,vecA7);
      ...
      pA8 = pulp_nn_i2_to_i8(pA8,vecA8);
    ...
    while (col_cnt_im2col)
    {
	    ...
	    int8_t inA5 = (int8_t) bitext((int) *pA5, 2, 0);
	    int8_t inA6 = (int8_t) bitext((int) *pA6, 2, 0);
	    int8_t inA7 = (int8_t) bitext((int) *pA7, 2, 0);
	    int8_t inA8 = (int8_t) bitext((int) *pA8, 2, 0);
      uint8_t inB1 = *pB1++;
      uint8_t inB2 = *pB2++;
      sum1 += inA1 * inB1;
      sum9 += inA5 * inB1;
      ...
      sum16 += inA8 * inB2;
	    ...
	    inA5 = (int8_t) bitext((int) *pA5, 2, 2);
	    inA6 = (int8_t) bitext((int) *pA6, 2, 2);
	    inA7 = (int8_t) bitext((int) *pA7, 2, 2);
	    inA8 = (int8_t) bitext((int) *pA8, 2, 2);
      inB1 = *pB1++;
      inB2 = *pB2++;
      sum1 += inA1 * inB1;
      sum9 += inA5 * inB1;
      ...
      sum16 += inA8 * inB2;
	    ...
	    inA5 = (int8_t) bitext((int) *pA5, 2, 4);
	    inA6 = (int8_t) bitext((int) *pA6, 2, 4);
	    inA7 = (int8_t) bitext((int) *pA7, 2, 4);
	    inA8 = (int8_t) bitext((int) *pA8, 2, 4);
      inB1 = *pB1++;
      inB2 = *pB2++;
      sum1 += inA1 * inB1;
      sum9 += inA5 * inB1;
      ...
      sum16 += inA8 * inB2;
	    ...
	    inA5 = (int8_t) bitext((int) *pA5, 2, 6);
	    inA6 = (int8_t) bitext((int) *pA6, 2, 6);
	    inA7 = (int8_t) bitext((int) *pA7, 2, 6);
	    inA8 = (int8_t) bitext((int) *pA8, 2, 6);
      inB1 = *pB1++;
      inB2 = *pB2++;
      sum1 += inA1 * inB1;
      sum9 += inA5 * inB1;
