                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 3); i++)
  {
    ...
    for(int j=0; j<(num_col_im2col_w >> 2); j++)
    {
      ...
      pA5 = pulp_nn_i4_to_i8(pA5,vecA5);
      ...
      pA6 = pulp_nn_i4_to_i8(pA6,vecA6);
      ...
      pA7 = pulp_nn_i4_to_i8(pA7,vecA7);
      ...
      pA8 = pulp_nn_i4_to_i8(pA8,vecA8);
    ...
    while (col_cnt_im2col)
    {
	    ...
	    int8_t inA5 = (int8_t) bitext((int) *pA5, 4, 0);
	    int8_t inA6 = (int8_t) bitext((int) *pA6, 4, 0);
	    int8_t inA7 = (int8_t) bitext((int) *pA7, 4, 0);
	    int8_t inA8 = (int8_t) bitext((int) *pA8, 4, 0);
      uint8_t inB1 = *pB1++;
      uint8_t inB2 = *pB2++;
      sum1 += inA1 * inB1;
      sum9 += inA5 * inB1;
      ...
      sum16 += inA8 * inB2;
	    ...
	    inA5 = (int8_t) bitext((int) *pA5, 4, 4);
	    inA6 = (int8_t) bitext((int) *pA6, 4, 4);
	    inA7 = (int8_t) bitext((int) *pA7, 4, 4);
	    inA8 = (int8_t) bitext((int) *pA8, 4, 4);
      inB1 = *pB1++;
      inB2 = *pB2++;
      sum1 += inA1 * inB1;
      sum9 += inA5 * inB1;
