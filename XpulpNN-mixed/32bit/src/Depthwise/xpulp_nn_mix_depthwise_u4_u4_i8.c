/*
 * xpulp_nn_mix_depthwise_u4_u4_i8.c
...
void xpulp_nn_mix_depthwise_u4_u4_i8(
                        uint8_t *pIn,
        ...
        do
        {
          ...
          if (flag_batch_norm && flag_relu)
          {
            ...
            *pOutBuffer = bitins(sum, n_mask, sum2, mask, off);
            sum3 = pulp_nn_bn_quant_u4(sum3, *k1, *lambda1, out_shift);
            sum4 = pulp_nn_bn_quant_u4(sum4, *(k1 + 1), *(lambda1 + 1), out_shift);
