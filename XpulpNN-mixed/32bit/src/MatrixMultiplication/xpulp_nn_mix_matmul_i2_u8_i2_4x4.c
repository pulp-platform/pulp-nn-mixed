/*
 * xpulp_nn_mix_matmul_i2_u8_i2_4x4.c
...
uint8_t * __attribute__((noinline)) xpulp_nn_mix_matmul_i2_u8_i2_4x4(
                        int8_t *pIn,
                        int8_t *pBias,
                        uint8_t *pOut,
                        uint8_t *pOut2,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 2); i++)
  {
    ...
    for(int j=0; j<(num_col_im2col >> 4); j++)
    {
      ...
      sum2 = MacLoads16(0, 0, 1, 0, ptrA, sum2);
      sum3 = MacLoads16(0, 0, 2, 0, ptrA, sum3);
      sum4 = MacLoads16(0, 1, 3, 0, ptrB, sum4);
      ptrB = MacLoadUpdate(ptrB);

      sum5 = MacLoads16(0, 0, 0, 1, ptrA, sum5);
      sum6 = MacLoads16(0, 0, 1, 1, ptrA, sum6);
      sum7 = MacLoads16(0, 0, 2, 1, ptrA, sum7);
      sum8 = MacLoads16(0, 1, 3, 1, ptrB, sum8);
      ptrB = MacLoadUpdate(ptrB);

      sum9  = MacLoads16(0, 0, 0, 0, ptrA, sum9);
      sum10 = MacLoads16(0, 0, 1, 0, ptrA, sum10);
      sum11 = MacLoads16(0, 0, 2, 0, ptrA, sum11);
      ...
      sum14 = MacLoads16(1, 0, 1, 1, ptrA, sum14);
      ptrA  = MacLoadUpdate(ptrA);

      sum15 = MacLoads16(1, 0, 2, 1, ptrA, sum15);
      ptrA  = MacLoadUpdate(ptrA);

      sum16 = MacLoads16(1, 0, 3, 1, ptrA, sum16);
      ptrA  = MacLoadUpdate(ptrA);
    ...
    if(col_cnt_im2col)
    {
      ...
      do
      {
        ...
        int8_t inB3 = (int8_t)bitext((int32_t) *pB3, 2, 0);
        int8_t inB4 = (int8_t)bitext((int32_t) *pB4, 2, 0);
        ...
        inB3 = (int8_t)bitext((int32_t) *pB3, 2, 2);
        inB4 = (int8_t)bitext((int32_t) *pB4, 2, 2);
        ...
        inB3 = (int8_t)bitext((int32_t) *pB3, 2, 4);
        inB4 = (int8_t)bitext((int32_t) *pB4, 2, 4);
        ...
        inB3 = (int8_t)bitext((int32_t) *pB3, 2, 6);
        inB4 = (int8_t)bitext((int32_t) *pB4, 2, 6);
  ...
  while(chan_left)
  {
    ...
    for(int j=0; j < (num_col_im2col >> 4); j++)
    {
      ...
      sum2 = MacLoads16(0, 1, 0, 1, ptrB, sum2);
      ptrB = MacLoadUpdate(ptrB);

      sum3 = MacLoads16(0, 1, 0, 0, ptrB, sum3);
      ptrB = MacLoadUpdate(ptrB);

      sum4 = MacLoads16(1, 0, 0, 1, ptrA, sum4);
      ptrA = MacLoadUpdate(ptrA);
    }
    int col_cnt_im2col = num_col_im2col & 0xf;
